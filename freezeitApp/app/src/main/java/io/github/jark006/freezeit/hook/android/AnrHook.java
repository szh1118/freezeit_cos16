...
public class AnrHook {
    ...
    MethodHook callbackErrorState = new MethodHook() {
        @Override
    ...
    // A11+ AnrHelper
    MethodHook callbackAnrHelper = new MethodHook() {
        @Override
        protected void beforeHookedMethod(MethodHookParam param) {
    ...
    // A10-A13
    MethodHook callbackServiceTimeout = new MethodHook() {
        @Override
        protected void beforeHookedMethod(MethodHookParam param) {
            final var processRecord = param.args[0];
    ...
    // A10-A13
    MethodHook callbackServiceForegroundTimeout = new MethodHook() {
        @Override
        protected void beforeHookedMethod(MethodHookParam param) {
