...
//        }
        ...
        // 静态广播
        skipReceiverLockedMethod = XpUtils.findMethodExactIfExists(
                Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE ?
                        Enum.Class.BroadcastQueueImpl : Enum.Class.BroadcastQueue,
     ...
     */
    MethodHook registeredReceiverCallback = new MethodHook() {
     ...
     */
    MethodHook receiverCallback = new MethodHook() {
        @SuppressLint("DefaultLocale")
        public void beforeHookedMethod(MethodHookParam param) {
